...
const Home = () => {
  ...
  return (
    <div className="mt-12 px-4">
      <h1 className="text-2xl font-semibold text-center mb-8">Welcome to the Dashboard</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {accessRight && (
          <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition">
            ...
            <p className="text-sm text-gray-600 mb-3">Manage all platform users, roles, and access rights.</p>
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition">
          ...
          <h2 className="text-lg font-semibold mb-1">{accessRight ? "Task Management" : "Your Tasks"}</h2>
          <p className="text-sm text-gray-600 mb-3">View, update and manage your tasks efficiently.</p>
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition">
          ...
          <p className="text-sm text-gray-600 mb-3">Keep your important thoughts and memos organized.</p>
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 text-center hover:shadow-xl transition">
          ...
          <p className="text-sm text-gray-600 mb-3">Track your sleep schedule and improve your rest.</p>
