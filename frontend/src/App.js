        ...
        <div className="container mt-3">
          <Routes>
            ...
            <Route element={<PersistLogin />}>
              ...
              <Route
                path="/login"
                element={!auth ? <Recaptcha /> : <Navigate to={link} />}
              />
              <Route
                path="/signup"
              ...
              <Route element={<RequireAuth />}>
                <Route
                  element={<RequireRoles Roles={[...Object.values(ROLES)]} />}
                >
                ...
                <Route element={<RequireRoles Roles={[ROLES.Root]} />}>
                  <Route path="/audit" element={<Audit />} />
                </Route>

                <Route
                  element={<RequireRoles Roles={[ROLES.Root, ROLES.Admin]} />}
                >
